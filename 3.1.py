...
# สร้างข้อมูลอุณหภูมิแบบสุ่มสำหรับ 3 เมือง (7 วัน x 4 เวลา)
temperature_data = [[[random.uniform(20, 40) for _ in range(times_per_day)] for _ in range(days)] for _ in range(3)]
